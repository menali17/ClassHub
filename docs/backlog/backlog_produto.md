...
| PB07 | Alertas de Baixa Frequência | HU06 | Seção no dashboard listando alunos com frequência inferior a 75%. | Alta | Lista exibe nome, turma e percentual de presença; dados recarregados ao abrir ou atualizar o dashboard; acesso limitado às turmas autorizadas. | PB06 | RF09 |
