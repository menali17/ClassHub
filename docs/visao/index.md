...
| Página | Conteúdo |
| --- | --- |
| [Artefatos UX/UI](artefatos_ux_ui.md) | Apresenta os artefatos de UX/UI do projeto, incluindo Sitemap, Wireframes e User Flows, responsáveis por estruturar a navegação, a organização das telas e a interação dos usuários com o sistema. |
| [Benchmarking](benchmarking.md) | Analisa soluções similares do mercado para identificar boas práticas, diferenciais competitivos e oportunidades para o desenvolvimento do sistema. |
...
A visão do produto serve como base para os demais documentos do projeto:

| Artefato | Relação com a visão |
| --- | --- |
| Requisitos | Derivam dos objetivos, necessidades dos usuários e solução proposta. |
